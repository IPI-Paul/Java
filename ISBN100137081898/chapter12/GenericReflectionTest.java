package chapter12;  // generic reflection
...
public class GenericReflectionTest {
	...
	private static final String CLASS_NAME = GenericReflectionTest.class.getName();
	...
	public static void main(String[] args) {
		...
		if (Threads.isInClosed() == false) {
			...
			try {
				...
				try {
					message = Threads.runJarProcess("cp", CLASS_NAME, "Chapter12", CLASS_NAME);
				} catch (AccessControlException ex) {
					message = Threads.getProcessJnlpMessage(CLASS_NAME);
				}
			}
		} else {
