...
public class SwingThreadTest {
	 private static final String MAIN_CLASS = "chapter14.Chpater14";
 ...
 * in errors because the combo box methods are not synchronised and both the worker thread and 
...
/**
 * This runnable modifies a combo box by randonly adding and removing numbers. In order to 
 * ensure that the combo is not corrupted, the editing operations are forwarded to the 
