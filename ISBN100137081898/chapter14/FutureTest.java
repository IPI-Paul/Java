	...
	public static void main(String[] args) {
		if (Threads.isInClosed() == false) {
			try {
				...
				message = Threads.runJarProcess("cp", FutureTest.class.getName(), "Chapter14", message);
			}
		} else {
...
class MatchCounter implements Callable<Integer> {
	 ...
	 * @param directoy the directory in which to start the search
	 * @param keyword the keyword to look for
	 */
	public MatchCounter(File directoy, String keyword) {
