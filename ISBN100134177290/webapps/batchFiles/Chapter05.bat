...
jar cvfe %jar%.jar %pack%.%jar% %pack%/*.class ipi/*.class sourceFiles/properties/*ch05.* drivers/derby*.jar drivers/*sql*.* drivers/ucanaccess/*.* sourceFiles/text/*ch05.* sourceFiles/scripts/*ch05.* sourceFiles/database/CoreJava.*
