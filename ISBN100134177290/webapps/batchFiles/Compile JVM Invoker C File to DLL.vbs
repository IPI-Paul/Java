...
while fld is nothing
  set fld = wShell.BrowseForFolder(0,"Choose a folder to store the C++ Executables in:" , &H0001 + &H0004 + &H0010 + &H0020,   "C:\Users\Paul\Documents\Studies\Java\ISBN100134177290\sourceFiles\exe")
...
set fld = nothing
while fld is nothing
  set fld = wShell.BrowseForFolder(0,"Choose the folder where the JDK\lib\jvm.lib is located:" , &H0001 + &H0004 + &H0010 + &H0020, "C:\Program Files\Java\jdk1.8.0_161\lib")
  if not fld is nothing then
    c = fld.self.path & "\jvm.lib"
  end if
wend
...
a = "cl -D_WINDWOS -I """ & a & """ -I """ & b & """ """ & d & """ """ & c & """ advapi32.lib"
a = replace(replace(a, "(", "{(}"), ")", "{)}")
if a > "" then
