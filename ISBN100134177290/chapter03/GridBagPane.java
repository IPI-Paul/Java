...
/**
 * This panel uses an XML file to describe its components and their bag layout positions. <br />
 */
public class GridBagPane extends JPanel {
	...
	/**
	 * Constructs a grid bag pane. <br />
	 * @param filename the name of the XML file that describes the pane's components and their positions <br />
	 */
	public GridBagPane(File file, Loaders lFile) {
		...
		try {
			...
			if ((file != null && file.toString().contains("-schema")) || 
					(lFile != null && lFile.toString().contains("-schema"))) {
			...
			try { 
				...
				builder.setEntityResolver(lFile.getEntityResolver(builder));
				doc = builder.parse(lFile.getInputStream());
			}
	...
	/**
	 * Gets a component with a given name. <br />
	 * @param name a component name <br />
	...
	/** 
	 * Parses a gridbag element. <br />
	 * @param e a gridbag element <br />
	 */
	...
	/**
	 * Parses a cell element. <br />
	 * @param e a cell element <br />
	 * @param r the row of the cell <br />
	 * @param c the column of the cell <br />
	 */
	private void parseCell(Element e, int r, int c) {
		...
		// uses reflection to get integer values of static fields 
	...
	/**
	 * Parses a bean element. <br />
	 * @param e a bean element <br />
	 */
	...
	/**
	 * Parses a value element. <br />
	 * @param e a value element <br />
	 */
