...
/**
 * A component that shows a set of coloured rectangles. <br /> 
 */
public class RectangleComponent extends JComponent {
	...
	/**
	 * Create a new random drawing. <br />
	 */
	...
	/**
	 * Creates an SVG document of the current drawing. <br />
	 * @return the DOM tree of the SVG document <br />
	 */
	...
	/**
	 * Writes an SVG document of the current drawing. <br />
	 * @param writer the document destination <br />
	 */
