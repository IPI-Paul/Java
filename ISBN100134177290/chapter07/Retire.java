...
/**
 * {@code Retire} class Listing 7.5 <br />
...
class RetireFrame extends JFrame {
	...
	private Locale[] locales = {Locale.UK, Locale.CHINA, Locale.GERMANY};
	...
	public RetireFrame() {
		...
		int localeIndex = 0; // UK locale is default selection
		for (int i = 0; i < locales.length; i++) 
			// if current locale one of choices, select it
			if (getLocale().equals(locales[i])) localeIndex = i;
		setCurrentLocale(locales[localeIndex]);
		
		localeCombo.addActionListener(event -> {
			setCurrentLocale((Locale) locales[localeCombo.getSelectedIndex()]);
			validate();
		});
		pack();
	}
	...
	/**
	 * Sets the current locale. <br />
	 * @param locale the desired locale <br />
	 */
	public void setCurrentLocale(Locale locale) {
		currentLocale = locale;
		localeCombo.setLocale(currentLocale);
		localeCombo.setSelectedItem(currentLocale.getDisplayName(currentLocale));
		 ...
		 */
		res = ResourceBundle.getBundle("chapter07.RetireResources", currentLocale);
		resStrings = ResourceBundle.getBundle("sourceFiles.properties.RetireStrings-ch07", currentLocale);
	...
	/**
	 * Updates all labels in the display. <br />
	 */
	...
	/**
	 * Updates the information in the text fields. <br />
	 */
	...
	/**
	 * Updates the data displayed in the text area. <br />
	 */
	...
	/**
	 * Reads the user input fro the text fields. <br />
	 */
	public void getInfo() {
		try {
...
/**
 * The information required to compute retirement income data. <br />
 */
class RetireInfo {
	...
	/**
	 * Gets the available balance for a given year. <br />
	 * @param year the year for which to compute the balance < br />
	 * @return the amount of money available (or required) in that year <br />
	 */
	...
	/**
	 * Gets the amount of prior savings. <br />
	 * @return the savings amount <br />
	 */
	...
	/**
	 * Sets the amount of prior savings. <br />
	 * @param newValue the savings amount <br />
	 */
	...
	/**
	 * Gets the annual contribution to the retirement account. <br />
	 * @return the contribution amount <br />
	 */
	...
	/**
	 * Sets the annual contribution to the retirement account. <br />
	 * @param new Value the contribution amount <br />
	 */
	...
	/**
	 * Gets the annual income. <br />
	 * @return the income amount <br />
	 */
	...
	/**
	 * Sets the annual income. <br />
	 * @param newValue the income amount <br />
	 */
	...
	/**
	 * Sets the current age. <br />
	 * @param newValue the age <br />
	 */
	...
	/**
	 * Gets the desired retirement age. <br />
	 * @return the age <br />
	 */
	...
	/**
	 * Sets the desired retirement age. <br />
	 * @param newValue the age <br />
	 */
	...
	/**
	 * Gets the expected age of death. <br />
	 * @return the age <br />
	 */
	...
	/** 
	 * Sets the expected age od death. <br />
	 * @param newValue the age <br />
	 */
	...
	/**
	 * Gets the estimated percentage of inflation. <br />
	 * @return the percentage <br />
	 */
	...
	/** 
	 * Sets the estimated percentage of inflation. <br />
	 * @param newValue the percentage <br />
	 */
	...
	/**
	 * Gets the estimated yiedl of the investment. <br />
	 * @return the percentage <br />
	 */
	...
	/**
	 * Sets the estimated yield of the investment. <br />
	 * @param newValue the percentage <br />
	 */
...
/**
 * This component draws a graph of the investment result. <br />
 */
class RetireComponent extends JComponent {
	...
	/**
	 * Sets the retirement information to be plotted. <br />
	 * @param newInfo the new retirement info <br />
	 */
	...
	/**
	 * Sets the color to be used before retirement. <br />
	 * @param color the desired color <br />
	 */
	...
	/**
	 * Sets the color to be used after retirement while the account balance is positive. <br />
	 * @param color the desired color <br />
	 */
	...
	/**
	 * Sets the color to be used after retirement when the account balance is negative. <br />
	 * @param color the desired color <br />
	 */
