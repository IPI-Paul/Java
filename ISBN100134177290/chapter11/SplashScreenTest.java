package chapter11;  // splashScreen
...
/**
 * {@code SplashScreenTest} class Listing 11.23 <br />
		...
		new SwingWorker<Void, Integer>() {
			...
			protected void process(List<Integer> chunks) {
				for (Integer chunk : chunks) {
					...
					progressBar.repaint();  // because img is loaded asychronously
				}
			}
			...
			protected void done() {
				...
				frame.setTitle("Splash Screen Test");
