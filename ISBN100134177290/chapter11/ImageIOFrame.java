...
/**
 * {@code ImageIOFrame} class extends JFrame Listing 11.7 <br />
...
public class ImageIOFrame extends JFrame {
	...
	/**
	 * Save the current image in a file. <br />
	...
	public void saveFile(final String formatName) {
		...
		try {
			...
			for (int i = 1; i < images.length; i++) {
				...
				if (writer.canInsertEmpty(i)) writer.writeInsert(i, iioImage, null);
			}
		} catch (IOException e) {
			JOptionPane.showMessageDialog(this, e);
		}
	...
	/**
	 * Gets a set of "preferred" format names of all image writers. The preferred format is the first 
	 * format name that a writer specifies. <br />
