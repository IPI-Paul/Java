package chapter11;  // renderQuality
...
/**
 * {@code RenderQualityTestFrame} class extends JFrame Listing 11.6 <br />
...
public class RenderQualityTestFrame extends JFrame {
	...
	/**
	 * Makes a set of buttons for a rendering hint key and values.  <br />
	 * @param key the key name <br />
	 * @param value1 the name of the first value for the key <br />
	...
	void makeButtons(String key, String value1, String value2) {
		try {
			...
			buttonBox.add(label, new GBC(0, r).setAnchor(chapter09.GBC.WEST));
...
class RenderQualityComponent extends JComponent {
	...
	public RenderQualityComponent() {
		image = new ImageIcon(ResourcePaths.getResource("img", "face.gif")).getImage();
	}
