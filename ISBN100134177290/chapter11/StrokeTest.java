...
/**
 * {@code StrokeTest} class Listing 11.2 <br />
...
class StrokeTestFrame extends JFrame {
	...
	/**
	 * Makes a radio button to change the cap style. <br />
	 * @param label the button label <br />
	 * @param style the cap style <br />
	...
	/**
	 * Makes a radio button to change the join style. <br />
	 * @param label the button label <br />
	 * @param style the join style <br />
	 * @param group the radio button group 
	 */
	private void makeJoinButton(String label, final int style, ButtonGroup group) {
		// select first in button in group
		boolean selected = group.getButtonCount() == 0;
		JRadioButton button = new JRadioButton(label, selected);
		buttonPanel.add(button);
		group.add(button);
		button.addActionListener(evenmt -> canvas.setJoin(style));
	}
	
	/**
	 * Makes a radio button to set solid or dashed lines <br />
	 * @param label the button label <br />
	 * @param style false for solid, true for dashed lines <br />
	 * @param group the radio button group
	 */
...
/**
 * This component draws two joined lines, using different stroke objects, and allows the user to drag the 
 * three points defining the lines.
 */
