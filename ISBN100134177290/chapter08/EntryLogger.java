package chapter08;  // bytecodeAnnotation
...
/**
 * {@code EntryLogger} class extends ClassVisitor Listing 8.12 <br />
 * {@link SetTest} class Listing 8.14 <br />
 * {@link Item} class Listing 8.13 <br />
 * Adds "entering" logs to all methods of a class that have the LogEntry annotation. <br />
...
public class EntryLogger extends ClassVisitor {
	...
	/**
	 * Constructs an EntryLogger that inserts logging into annotated methods of a given class. <br />
	 * @param cg the class <br /> 
	 */
			...
			public AnnotationVisitor visitAnnotation(String desc, boolean visible) {
				return new AnnotationVisitor(Opcodes.ASM5) {
					public void visit(String name, Object value) {
						 ...
						 */
						if (desc.equals("Lchapter08/LogEntry;") && name.equals("logger"))
	...
	/** 
	 * Adds entry logging code to the given class. <br />
	 * @param args the name of the class file to patch <br />
	 */
	public static void main(String[] args) throws IOException {
		if (args.length == 0) {
			...
			System.exit(1);
			 */
			System.out.println("USAGE: java chapter08.EntryLogger classfile");
		}
		Path path = Paths.get(args[0]);
		ClassReader reader = new ClassReader(Files.newInputStream(path));
		ClassWriter writer = new ClassWriter(ClassWriter.COMPUTE_MAXS | ClassWriter.COMPUTE_FRAMES);
		EntryLogger entryLogger = new EntryLogger(writer, path.toString().replace(".class", "")
				.replaceAll("[/\\\\]", "."));
