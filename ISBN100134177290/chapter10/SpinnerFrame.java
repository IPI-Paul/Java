...
/**
 * {@code SpinnerFrame} class extends JFrame Listing 10.23 <br />
...
public class SpinnerFrame extends JFrame {
	...
	/**
	 *  Adds a row to the main panel. <br />
	 *  @param labelText the label of the spinner <br />
	 *  @paramspinner the sample spinner 
	 */
