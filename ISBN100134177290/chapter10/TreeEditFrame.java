...
/**
 * {@code TreeEditFrame} class extends JFrame Listing 10.13 <br />
...
public class TreeEditFrame extends JFrame {
	...
	/**
	 * Makes the buttons to add a sibling, add a child, and delete a node. <br />
	 */
	public void makeButtons() {
		...
		deletButton.addActionListener(event -> {
			DefaultMutableTreeNode selectedNode = (DefaultMutableTreeNode) tree
					.getLastSelectedPathComponent();
