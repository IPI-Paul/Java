package chapter10;  // progressMonitorInputStream
...
/**
 * {@code TextFrame} class extends JFrame Listing 10.28 <br />
...
public class TextFrame extends JFrame {
	...
	/**
	 * Prompts the user to select a file, loads the file into a text area, and sets it as the content pane 
	 * of the frame.
	 */
	public void openFile() throws IOException {
		...
		// set up stream and render filter sequence
