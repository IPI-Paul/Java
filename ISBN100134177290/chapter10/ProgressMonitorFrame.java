package chapter10;  // progressMonitor

import java.awt.*;
import javax.swing.*;

/**
 * {@code ProgressMonitorFrame} class extends JFrame Listing 10.27 <br />
...
public class ProgressMonitorFrame extends JFrame {
	...
	public ProgressMonitorFrame() {
		...
		startButton.addActionListener(event -> {
			...
			progressDialog = new ProgressMonitor(ProgressMonitorFrame.this, "Waiting for Simulated Activity",
					null, 0, MAX);
			cancelMonitor.start();
		});
		...
		cancelMonitor = new Timer(500, event -> {
			if (progressDialog.isCanceled()) {
				...
				progressDialog.setProgress(activity.getCurrent());
			}
		});
		pack();
	}
	...
	class SimulatedActivity extends SwingWorker<Void, Integer> {
		...
		/**
		 * Constructs the simulated activity that increments a counter from 0 to a given target. <br />
