...
/**
 * {@code TabbedPaneFrame} class extends JFrame Listing 10.30 <br />
...
public class TabbedPaneFrame extends JFrame {
	...
	public TabbedPaneFrame() {
		...
		// we set the components to null and delay their loading until the tab is shown for the first time
		ImageIcon icon = new ImageIcon(ResourcePaths.getResource("img", "yellow-ball.gif"));
	...
	/**
	 * Loads the tab with the given index. <br />
	 * @param n the index of the tab to load
	 */
	private void loadTab(int n) {
		String title = tabbedPane.getTitleAt(n);
		ImageIcon planetIcon = new ImageIcon(ResourcePaths.getResource("img", title + ".jpg"));
		tabbedPane.setComponentAt(n, new JLabel(planetIcon));
		
		// indicate that this tab has been visited--just for fun
		tabbedPane.setIconAt(n, new ImageIcon(ResourcePaths.getResource("img", "red-ball.gif")));
	}
}
