...
/**
 * {@linkcode ColorFrame1} class extends JFrame Listing 10.32 <br />
	...
	class PanelLayer extends LayerUI<JPanel> {
		...
		public void paint(Graphics g, JComponent c) {
			...
			int red = Integer.parseInt(
				redField.getText().trim().length() == 0 ? "0" : 
				Integer.parseInt(redField.getText().trim()) > 255 ? "255" : redField.getText().trim());
			int green = Integer.parseInt(
				greenField.getText().trim().length() == 0 ? "0" : 
					Integer.parseInt(greenField.getText().trim()) > 255 ? "255" : greenField.getText().trim());
			int blue = Integer.parseInt(
				blueField.getText().trim().length() == 0 ? "0" : 
					Integer.parseInt(blueField.getText().trim()) > 255 ? "255" : blueField.getText().trim());
