...
/**
 * {@code WordCheckPermission} class extends Permission Listing 9.5 <br />
 ...
 * A permission that checks for bad words. <br />
...
public class WordCheckPermission  extends Permission {
	...
	/**
	 * Constructs a word check permission. <br />
	 * @param target a comma separated word list <br />
	 * @param anAction "insert" or "avoid" <br />
	 */
	...
	/**
	 * Gets the bad words that this permission rule describes. <br />
	 * @return a set of the bad words <br />
	 */
