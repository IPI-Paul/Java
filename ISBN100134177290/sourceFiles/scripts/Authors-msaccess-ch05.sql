DROP TABLE Authors;
CREATE TABLE Authors (Author_Id AUTOINCREMENT,firstName varchar(20) NOT NULL,lastName varchar(30) NOT NULL,Name varchar(50) NOT NULL,PRIMARY KEY (Author_Id));
