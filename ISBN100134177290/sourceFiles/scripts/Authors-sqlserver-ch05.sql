DROP TABLE Authors;
CREATE TABLE Authors (Author_Id INT NOT NULL IDENTITY,firstName varchar(20) NOT NULL,lastName varchar(30) NOT NULL,Name varchar(50) NOT NULL,PRIMARY KEY (Author_Id));
