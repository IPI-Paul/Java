/**
 	Printf2.c Listing 12.10
	Printf2Test class Listing 12.8
	chapter12_Printf2 class Listing 12.9
 	chapter12_Printf2.h Listing 12.9
	@version 1.10 1997-07-01
	@author Cay Horstmann
	This code implements the C function. It calls GetStringUTFChars to read the format argument, 
	NewStringUTFto generate the return value, and ReleaseStringUTFChars to inform the virtual machine that 
	access to the string is no longer required.
*/

#include "chapter12_Printf2.h"
#include <string.h>
#include <stdlib.h>
#include <float.h>
...
JNIEXPORT jstring JNICALL Java_chapter12_Printf2_sprint(JNIEnv* env, jclass cl, jstring format, jdouble x) {
	const char* cformat;
	char* fmt;
	jstring ret;
