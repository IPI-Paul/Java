/**
	chapter12_InvocationTest.c Listing 12.20
...
int main() {
	...
	options[0].optionString = "-Djava.class.path=C:\\Users\\Paul\\Documents\\Studies\\Java\\ISBN100134177290";
	...
	class_Welcome = (*env) -> FindClass(env, "chapter12/Welcome");
	if(!class_Welcome) {
		printf("Unable to find class: chapter12/Welcome\n");
		fflush(stdout);
		return -2;
	}
