/**
	Printf3Test class Listing 12.14
	Printf3 class Listing 12.15
 	chapter12_Printf3.h Listing 12.15
	chapter12_Printf3.c Listing 12.16
	@version 1.10 1997-07-01
	@author Cay Horstmann
*/

#include "chapter12_Printf3.h"
#include <string.h>
#include <stdlib.h>
#include <float.h>
...
char* find_format(const char format[]) {
	...
	while (q != NULL && *(q + 1) == '%') /* skip %% */
		q = strchr(q + 2, '%');
	while (q != NULL) return NULL; /* % not unique */
...
JNIEXPORT void JNICALL Java_chapter12_Printf3_fprint(JNIEnv* env, jclass cl, jobject out, 
